...
var (
	...
	// module accounts that are allowed to receive record
...
func NewSimApp(
	...
	app.mm.SetOrderBeginBlockers(
		...
		evidencetypes.ModuleName, stakingtypes.ModuleName, ibchost.ModuleName, recordtypes.ModuleName,
	)
	app.mm.SetOrderEndBlockers(crisistypes.ModuleName, govtypes.ModuleName, stakingtypes.ModuleName)

	// NOTE: The genutils moodule must occur after staking so that pools are
	// properly initialized with records from genesis accounts.
